import { RawLifeStyle, RawTechStack, InputAboutData } from "@/types/about";
import { SocialMedia } from "@/types/socail-media";

export const isLifeStyle = (obj: unknown): obj is RawLifeStyle => {
...
export const isTechStack = (obj: unknown): obj is RawTechStack => {
  if (!isObject(obj)) return false;
  return (
...
export const isAbout = (obj: unknown): obj is InputAboutData => {
  if (!isObject(obj)) return false;
  return (
