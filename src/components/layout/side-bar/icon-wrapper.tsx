...
export function convertContactIcon(contact: { icon: string; title: string; content: string; link?: string }) {
  return {
    ...contact,
...
export function convertSocialLinkIcon(socialLink: { url: string; icon: string; name: string }) {
  return {
    ...socialLink,
