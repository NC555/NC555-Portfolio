...
const giscusConfig = {
  ...
  theme: rawGiscusConfig.theme as 'light' | 'dark' | 'dark_dimmed' | 'dark_high_contrast' | 'dark_protanopia' | 'dark_deuteranopia' | 'dark_tritanopia' | 'light_high_contrast' | 'light_protanopia' | 'light_deuteranopia' | 'light_tritanopia' | 'transparent_dark' | 'preferred_color_scheme',
};
...
const BlogPostView: React.FC<BlogPostViewProps> = ({ post, enableMath = false, isAdminPreview = false }) => {
  ...
  const shareUrl = isAdminPreview ? "#" : `https://www.NC555.com/post/${post.slug}`;
      ...
      <article>
        <section className="blog-text">
          ...
          <div className="flex justify-center">
            <div className="w-[90%] sm:w-[90%] md:w-[90%] lg:w-[80%] xl:w-[80%] text-light-gray">
              <MarkdownRenderer content={post.content || "No content"} enableMath={enableMath} />
            </div>
          </div>
        </section>
      </article>
