...
<img src="./public/demo/sidebar-editor.gif" alt="Sidebar Editor" width="520" style="max-width:75%; margin-bottom: 25px;"/> 
<h3>Home Page Editor</h3>
<img src="./public/demo/home-editor.jpg" alt="Home Editor" width="520" style="max-width:75%; margin-bottom: 25px;"/> 
<h3>Resume Editor</h3>
<img src="./public/demo/resume-editor.jpg" alt="Resume Editor" width="520" style="max-width:75%; margin-bottom: 25px;"/> 
